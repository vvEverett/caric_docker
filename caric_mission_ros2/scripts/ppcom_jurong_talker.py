...
class JurongTalker(Node):
    ...
    def __init__(self):
        ...
        # Create publisher
        self.msg_pub = self.create_publisher(String, '/jurong/ping_message', 10)
        
        # Create subscribers for other nodes
        self.raffles_sub = self.create_subscription(
            String,
            '/domain1/raffles/ping_message',
    ...
    def register_topic(self):
        ...
        request.targets = ['all']
        request.topic_name = '/jurong/ping_message'

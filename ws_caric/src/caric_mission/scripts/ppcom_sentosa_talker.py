...
if __name__ == '__main__':
    ...
    rospy.init_node('sentosa_talker', anonymous=False)
    ...
    response = create_ppcom_topic('sentosa', ['raffles'], '/ping_message', 'std_msgs', 'String')
    print(f"Response {response}")

    # Create the publisher
    msg_pub = rospy.Publisher('/ping_message', String, queue_size=1)
    ping_message_sub = rospy.Subscriber('/ping_message/sentosa', String, PingMessageCallback)
